...
def test_break_prediction():
    ...
    test_scenarios = [
        {
            "name": "High Risk: Long drive + High sleep debt + Health conditions",
            "start_time": datetime.now(timezone.utc).replace(hour=6, minute=0),  # 6 AM start
        ...
        {
            "name": "Moderate Risk: Some sleep debt + Age factor",
            "start_time": datetime.now(timezone.utc).replace(hour=8, minute=0),  # 8 AM start
        ...
        {
            "name": "Low Risk: Young driver + Minimal sleep debt",
            "start_time": datetime.now(timezone.utc).replace(hour=9, minute=0),  # 9 AM start
